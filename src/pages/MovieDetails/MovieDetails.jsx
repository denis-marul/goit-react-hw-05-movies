...
const MovieDetails = () => {
    ...
    return <div className={css.MovieDetails}>
        ...
        <div className={css.Genres}>
            {movieParams.genres && movieParams.genres.map(genre => {
                return <p className={css.GenreItem} key={genre.id}>{genre.name}</p>
            }) }
             </div>
        ...
        <ul className={css.AddList}>
            <li><Link className={css.AddListLink} to="cast">Cast</Link></li>
            <li><Link className={css.AddListLink} to="rewiews">Rewiews</Link></li>
        </ul>
